...
class PluginNewsAlert extends CommonDBTM {
   ...
   **/
   ...
   function getCountAllTickets($id_type){
      global $DB;
      ...
      echo "<div class=''>
                <div class='alert text-start alert text-start alert-warning alert-important alert-dismissible'>
                            <h3>
                              Tous les tickets en ce moment
                            </h3>
                            
                            <div class='mt-2 plugin_news_alert-content'>
                              <div class = 'flex'>
                                 <div class ='first'>";
                                $incident_count = getCountAllTickets(1);
                                echo "Incidents<br>"; //$incident_count;
                                echo $incident_count;
                                echo "</div>
                               
                                <div class ='second'>";
                                $demande_count = getCountAllTickets(2);
                                echo "Demandes<br>"; //$demande_count;
                                echo $demande_count;
                                echo "</div>
                              </div>
                              </div>
